		...
		<el-form :model="state.searchForm" ref="formRef">
			<el-row :gutter="10">
				...
				<el-form-item class="ml5">
					...
					<el-button type="success" :icon="Plus" @click="onAddClick">新增广告</el-button>
				</el-form-item>
			</el-row>
		</el-form>
...
import { list, del, batchDel } from '@/api/ad.api.js'
...
const columns = [
	...
	{ label: '公司名称', prop: 'companyName', width: 160, showOverflowTooltip: true },
	{ label: '链接地址', prop: 'url', slot: 'url', showOverflowTooltip: true },
	{ label: '广告费用', prop: 'price', slot: 'price', width: 120 },
	{ label: '广告有效期', prop: 'expireTime', width: 180 },
	{ label: '图片', prop: 'cover', slot: 'cover', width: 120 },
